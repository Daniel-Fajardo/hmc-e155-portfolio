...
The setdur function is more simple. ARR is set by defining the total length of the desired duration with (80MHz/prescalar)*duration/1000.
...
The circuit for this lab is very simple. Figure 3

# Results and Discussion

{{< video https://youtu.be/96BAVuoL1Xo>}}

As heard (quietly) in the video, the speaker can play Fur Elise at the correct pitch and tempo. 
